...
int minimumTemperature = 35; //minimum temperature
int maximumTemperature = 45; //maximum temperature
int shutterOpenTemperature =38; //temparature value to open upper shutter
//------soil moisture-------
int soilMoisturesensorValue;  //store value of soil moisture sensor
float soilMoisturePercentage; //store converted value of soil moisture sensor to percentage
int moistureMinimum = 40; // minimum moisture value
int moistureMaximum = 60; // maximum moisture value
//---------SERVO----------
int servoPositionBrownWaste = 0;//store initial positon of servo(brown waste)
int delayTimeBWServo = 25; //store delay time of servo during operation
